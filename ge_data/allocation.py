...
# python -m ge_data.allocation --outdir /your-datasets-path/llama3_data_8b
# python -m ge_data.allocation --outdir /your-datasets-path/llama2_data_7b
# python -m ge_data.allocation --outdir /your-datasets-path/vicuna_data_7b
# python -m ge_data.allocation --outdir /your-datasets-path/llama2_data_13b