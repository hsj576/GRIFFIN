...
bigname="/your-model-paths/Llama-2-7b-chat-hf"
#bigname="/your-model-paths/llama-2-13b-chat-hf"
...
def build_dataset_rank(
    ...
    ds = load_dataset('json', data_files="/your-datasets-path/ShareGPT_Vicuna_unfiltered/ShareGPT_V4.3_unfiltered_cleaned_split.json")
    ds = ds['train']
