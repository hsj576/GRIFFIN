...
from .cnets_griffin_1 import Model
...
class EaModel(nn.Module):
    ...
    def from_pretrained(
        ...
        print('model.ea_layer.total_tokens: ', model.ea_layer.total_tokens)
    ...
    def eagenerate(
        ...
        if not log:
            return input_ids, start_time
        else:
            return input_ids, new_token, idx, start_time
